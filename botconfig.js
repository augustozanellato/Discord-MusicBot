module.exports = {
  Admins: [process.env.AdminId || ""], //Admins of the bot
  ...
  //Lavalink
   Lavalink: {
    id: "Main",
    host: process.env.LavalinkHost || "lava.link",
    port: process.env.LavalinkPort || 80,
    pass: process.env.LavalinkPass || "somethingsomething", 
